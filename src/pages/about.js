  ...
  <Layout>
    ...
    <TextWrapper>
      <div>
        ...
        <GenereicPara lessSize grey>GeekyHacker is an experienced and
        passionate group of designers, developers, and artists. Every
        client we work with becomes part of the team. Together we
        face the challenges and celebrate the victories.
        </GenereicPara>
        <Link to="/works" className="button__primaryT">Our Work</Link>
      </div>
    </TextWrapper>
  </section>
  <SectionTwo white>
