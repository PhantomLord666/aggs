...
import { Banner, TextWrapper, MoreText, SectionTwo, 
          SectionThree, FlexBoxIndex, GenereicPara, GenericH2, 
          SectionFour, FormFive} from "../styles/IndexStyles.js";
import Layout from "../components/layout"
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { library } from '@fortawesome/fontawesome-svg-core';
import { fab, faHtml5, faJs, faReact, faCss3, faGalacticSenate } from
...
export default () => (
  ...
  <TextWrapper>
    <div>
      ...
      <Link to="/works" className="button__primaryT">Our Works</Link>
    </div>
  </TextWrapper>
...
<SectionThree>
  <FlexBoxIndex>
    ...
    <div className="text__section3">
      ...
      <GenereicPara lessSize lessSpacing>We hand code beautiful websites using HTML5, 
        CSS3, JS because they are fully customizable and efficient. No Worpress websites here.
      </GenereicPara>      
    </div>
  </FlexBoxIndex>
  <FlexBoxIndex inverse>
    <div className="text__section3">
      ...
      <GenereicPara lessSize lessSpacing>We have talented and experienced Web Designers, 
          who can design beautiful and usable websites.
      </GenereicPara>
    </div>
    <div className="image">
  ...
  <FlexBoxIndex>
    ...
    <div className="text__section3">
      <GenericH2>Mobile App Development</GenericH2>
      <GenereicPara lessSize lessSpacing>We develop Mobile apps in Reactive Native, 
            which can be used in both ios and Android.
      </GenereicPara>
    </div>
  </FlexBoxIndex>
</SectionThree>
