...
const projects = [
    {image: 'banner.jpg', title: "PrintBill", link: "https://www.printbill.in/"},
...
<Layout>
  <Works>
    <GenericH2 none some style={{textAlign: 'center'}} className="button">Proyectos</GenericH2>
    <section class="gallery__flex">
      { projects && projects.map(proj => <Project key={proj.title}
      project={proj} />)}
    </section>
  </Works>
</Layout>
