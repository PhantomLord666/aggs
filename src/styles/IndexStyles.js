...
export { Banner, TextWrapper, MoreText, SectionTwo, SectionThree, 
          FlexBoxIndex, GenereicPara, GenericH2, SectionFour, FormFive, 
          Footer, Header, Works, GenericH3, GenereicParaAbout };
